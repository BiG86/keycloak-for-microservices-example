...
@EnableJpaRepositories(basePackages = {"it.snorcini.dev.bookmanager.repository", "it.snorcini.dev.bookmanager.entity"})
@EntityScan(basePackages = "it.snorcini.dev.bookmanager.*")

...
public class ActivitiesDTO extends AbstractBaseDTO {
     ...
     */
    @NotNull(message = BookManagerValidationErrors.EMPTY_DATE_INSERT)
    private OffsetDateTime dateInsert;

    /**
     * Contains last modification date.
     */
    @NotNull(message = BookManagerValidationErrors.EMPTY_DATE_MODIFY)
    private OffsetDateTime dateModify;

    /**
     * Contains username of last modification.
     */
    @NotEmpty(message = BookManagerValidationErrors.EMPTY_LAST_USER_MODIFY)
    @Size(max = 256, message = BookManagerValidationErrors.LAST_USER_MODIFY_TOO_LONG)
